...
import barayuda.com.movieapp.Adapter.RecycleListAdapter;
import barayuda.com.movieapp.Adapter.TrailerListAdapter;
...
public class MovieDetail extends AppCompatActivity {
    ...
    int movie_id = 0;
    private final String API_KEY = "?api_key=709ea1e158ff0075a9d5a7fcb6bbd53c";
    ...
    public class GetTrailer extends AsyncTask<String, Void, List<Trailer>> {
        ...
        protected List<Trailer> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(String.format("%s%s", BASE_URL, API_KEY)).buildUpon()
                        .build();
